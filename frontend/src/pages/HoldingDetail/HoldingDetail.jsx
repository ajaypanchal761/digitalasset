        ...
        <div className="holding-detail__section">
          ...
          <div className="holding-detail__details-list">
            ...
            <div className="holding-detail__detail-item">
              ...
              <span className="holding-detail__detail-value holding-detail__detail-value--green">0.5% + 5% yearly</span>
            </div>
            <div className="holding-detail__detail-item">
        ...
        <div className="holding-detail__section">
          ...
          <div className="holding-detail__earnings-card">
            <div className="holding-detail__earnings-item">
              ...
              <span className="holding-detail__earnings-subtext">Starting at 0.5% with 5% yearly increments (after 3-month lock-in)</span>
            </div>
            <div className="holding-detail__earnings-item">
