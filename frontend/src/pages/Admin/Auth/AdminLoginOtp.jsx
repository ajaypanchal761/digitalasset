...
const AdminLoginOtp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setIsSubmitting(true);
      const loginResponse = await adminAuthAPI.loginWithOTP({
        phone: phoneNumber,
        otp: otpString,
      });
    ...
    <div className="admin-verify-otp-page">
      <div className="admin-verify-otp-container">
        ...
        <div className="admin-verify-otp-content">
          <h1 className="admin-verify-otp-title">Admin Sign In</h1>
          <p className="admin-verify-otp-subtitle">
            Enter the Code sent to <span className="admin-phone-number">{phone}</span>
          </p>
          ...
          <div className="admin-verify-otp-footer">
            ...
            <p className="admin-verify-otp-switch">
              <Link to="/admin-auth/login">Change phone number</Link> | <Link to="/auth/login">User Login</Link>
            </p>
          </div>
        </div>
      </div>
